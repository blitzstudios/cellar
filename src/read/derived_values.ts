...
export function isEntityCacheDeclaration(decl: unknown): decl is EntityCacheDeclaration<RowShape, unknown> {
  return typeof decl === 'object' && decl !== null && (decl as { kind?: unknown }).kind === 'byEntity';
}
