...
import { readRows, reportStoreDegradation } from "../index.js";
 ...
 */
function openNitroInMemory(dbName, opts) {
  ...
  try {
    ...
    const [main] = readRows(conn, "SELECT file FROM pragma_database_list WHERE name = 'main';");
