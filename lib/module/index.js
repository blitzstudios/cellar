...
export { configureDataKernel, INERT_ERRORS, INERT_QUERY } from "./runtime.js";
...
export { cacheKey, KEY_SEP, stableKey } from "./args_key.js";
export { createBoundedLru, declareMemos, byVersion, bySource, shallowEqualRecord, shallowEqualArray, shallowEqualStruct } from "./caches.js";

// The table a store's schema describes, and the rows it holds.

export { createMemoryRowTable } from "./table/memory.js";
...
export { shredColumnDefs, shredColumnNames, shredColumnOps, shredRow } from "./write/shred_columns.js";
export { evalShredElement } from "./write/shred_spec.js";

// Declaring reads, and turning rows into view models.

export { groupRowsBy, indexRowsBy, mapRows, orderedByIds } from "./read/row_shaping.js";
export { pairRead } from "./read/facade.js";
export { createWindowedList } from "./read/windowed_list.js";

// Repainting on a write.

export { createVersionAtom, isLive } from "./reactivity/version_atom.js";
...
export { createOnceGuard, resetOnceGuards } from "./diagnostics/once_guard.js";
