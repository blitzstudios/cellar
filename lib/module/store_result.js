 ...
 */
export const DATA_RESULT_KEYS = ['data', 'status', 'isLoading', 'isFetching', 'isSuccess', 'isError', 'refetch'];
const NOOP_REFETCH = () => {};
 ...
 */
export function makeResult(data, status, opts) {
...
export function offHeapStatus(enabled, hasData, prime) {
