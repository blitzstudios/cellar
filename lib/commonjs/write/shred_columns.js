...
exports.shredColumnDefs = shredColumnDefs;
exports.shredColumnNames = shredColumnNames;
exports.shredColumnOps = shredColumnOps;
exports.shredRow = shredRow;
/**
...
function shredColumnDefs(columns) {
  const defs = {};
 ...
 */
function shredColumnNames(columns) {
 ...
 */
function shredColumnOps(columns) {
 ...
 */
function shredRow(columns, src, ctx) {
  const row = {};
